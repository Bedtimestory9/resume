...
import { Mail, Github, Phone, ExternalLink, DollarSign } from "lucide-react";
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <Card className="p-8 md:p-12 elegant-shadow backdrop-blur-sm bg-card/95">
          <div className="grid md:grid-cols-4 gap-8">
            {/* Email */}
            <a href="mailto:lawrencefandango@gmail.com" className="group">
            ...
            {/* PayPal */}
            <a
              href="https://www.paypal.com/paypalme/zongkiang"
              target="_blank"
              rel="noopener noreferrer"
              className="group"
            >
              <div className="text-center p-6 rounded-lg smooth-transition hover:bg-muted/50 hover:scale-105">
                <div className="w-16 h-16 bg-yellow-500/10 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-yellow-500/20 smooth-transition">
                  <DollarSign className="w-8 h-8 text-yellow-500" />
                </div>
                <h3 className="text-lg font-semibold mb-2">PayPal</h3>
                <p className="text-muted-foreground text-sm mb-2">Support me</p>
                <p className="text-yellow-500 font-medium text-sm flex items-center justify-center gap-1">
                  zongkiangso@outlook.com <ExternalLink className="w-3 h-3" />
                </p>
              </div>
            </a>
          </div>
